package ru.andreyv.bytesandpixels;
...
public class PictureCapturingServiceImpl extends APictureCapturingService {
    ...
    private void saveImageToDisk(final byte[] bytes) {
        ...
        final File file = new File(Environment.getExternalStorageDirectory() + "/bytesandpixels/" + cameraId + "_pic.jpg");
        //final File file = new File("/bytesandpixels/" + cameraId + "_pic.jpg");
